...
export const featuresData = [
...

  {
    ...
    icon: <SiAntdesign />,
    title: "Blender",
    des: "Discover endless creativity with Blender! From 3D modeling to animation, Blender lets you unleash your imagination. Let's create something incredible together",
  },
  {
    id: 6,
    icon: <FaGlobe />,
    title: "Unreal engine",
    des: "Unleash your creativity with Unreal Engine! Build stunning worlds, craft thrilling gameplay, and push boundaries. Let's make something incredible togethe",
  },
];
